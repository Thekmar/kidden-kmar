...
//         <h2 className="text-4xl font-poppins font-bold text-black mb-5">
//           What Do Parents <br />
//           Say About Us!
//         </h2>
//         <p className="text-gray-500 text-xl mb-12 font-comic">
//           Kindergarten is an early childhood educational environment where most <br />
...
//               className={`${testimonial.bgColor} ${testimonial.textColor} rounded-[6rem] flex flex-col items-center px-10 pt-16 pb-10 shadow-lg w-full md:w-1/3 min-h-[400px] relative`}
//               style={idx === 1 ? { zIndex: 2 } : { zIndex: 1 }}
//             >
//               <img
//                 src={testimonial.image}
//                 alt={testimonial.name}
//                 className="w-28 h-28 object-cover rounded-full border-4 border-white shadow-lg absolute left-1/2 -translate-x-1/2 -top-14"
//                 style={{ top: "-56px" }}
//               />
...
//                 </div>
//                 <div
//                   className={`font-bold mt-1 mb-3 text-xl ${testimonial.roleColor}`}
//                 >
//                   {testimonial.role}
//                 </div>
//                 <p className="font-comic text-lg leading-8">
//                   {testimonial.quote}
//                 </p>
